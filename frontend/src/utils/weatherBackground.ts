...
export const getWeatherBackground = (weather: WeatherInfo) => {
  const backgrounds = {
    ...
    rainy: 'https://images.unsplash.com/photo-1534274988757-a28bf1a57c17?auto=format&fit=crop&q=80',
    cloudy: 'https://images.unsplash.com/photo-1534088568595-a066f410bcda?auto=format&fit=crop&q=80',
    partlyCloudy: 'https://images.unsplash.com/photo-1601297183305-6df142704ea2?auto=format&fit=crop&q=80',
    sunny: 'https://images.unsplash.com/photo-1561484930-998b6a7b22e8?auto=format&fit=crop&q=80',
    misty: 'https://images.unsplash.com/photo-1485249245068-d8dc50b77cc7?auto=format&fit=crop&q=80'
  };
